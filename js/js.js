...
L.tileLayer(
  "https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}{r}?access_token={accessToken}",
  {
    ...
    zoomOffset: -1,
    accessToken:
      "pk.eyJ1IjoiaXdhbm5hdG9jb2RlIiwiYSI6ImNrcmIxM3N2bjNrZm8ycHJ4aWttaGs0bHgifQ.vlvWrLKCK75U1Rl0wXO26Q",
  }
).addTo(mymap);
...
// detectar ip location y  la ubica
//funcion
...
//llamado a la funcion q ubica
$(".btn").click(putLocation);
